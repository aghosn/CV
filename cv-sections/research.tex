...
%------------------------------------------------
\cventry
{MSR: Marios Kogias, EPFL: Prof. Edouard Bugnion, Prof. James Larus, Prof. Mathias Payer}
{Ongoing Research}
{Cambridge, UK}
{Nov. 2021 - Present}
{ %TODO bridging gap between hardware features and programming languages
	\begin{cvitems}
  \item{Tyche: supporting all TEE programming models on legacy hardware}
	\end{cvitems}
}
...
{EPFL, DSCL - Prof. Edouard Bugnion, Prof. James Larus, Prof. Mathias Payer}
  {Enclosures: Language-based restriction of untrusted libraries~\cite{enclosure}}
{Lausanne, Switzerland}
{Sep. 2019  - Oct. 2020}
{
	\begin{cvitems}
...
{EPFL, DSCL - Prof. Edouard Bugnion, Prof. James Larus}
  {\href{https://www.usenix.org/system/files/atc19-ghosn_0.pdf}{Secured Routines: Language-based construction of TEEs~\cite{gotee}}}
{Lausanne, Switzerland}
{Jun. 2018  - May 2019}
{
	\begin{cvitems}
